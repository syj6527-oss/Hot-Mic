...
const MODE_SUBSTYLES = {
    docu: [
        '【야생 다큐 / 내셔널지오·BBC st】 데이비드 애튼버러식. 장엄한 도입("이른 아침, 미명이 깔린 좁은 서식지에서…")으로 장면을 영화처럼 연다. 인간을 철저히 야생 개체로: 수컷·암컷·서식지·영역·서열·번식기·구애·포식자. 동물행동학 용어로 포장("정착 본능", "우위 과시", "~로 관찰된다") 후 시시한 진실로 착지. 절대 흥분하지 않는 차분하고 우아한 톤.',
        '【인간극장 st】 잔잔하고 먹먹한 휴먼 다큐. 느리고 따뜻한 내레이션. "그가 살아온 세월은…", "묵묵히, 또 묵묵히…", "말은 없지만", "그래도, 그렇게 살아간다". 사소한 행동에 인생의 무게를 실어주다 실상은 시시해서 웃김. 쉼표 많고 여백 있는 문장. 애잔한 BGM이 깔리는 듯한 톤.',
        ...
        '【그것이 알고싶다 st】 시사고발·미스터리 추적. 음산하고 진지한 의혹 제기. "그는 왜 그랬을까", "제작진은 의문을 품었다", "그러나 진실은 달랐다", "취재 결과, 충격적인 사실이 드러났다". 사소한 행동을 미제 사건처럼. 긴장감 조성하는 끊어치는 문장, 의미심장한 여운.',
    ],
    sports: [
    ...
    wiki: [
        ...
        '【나무위키 st】 덕질 위키 특유의 드립·여담. 취소선 드립(예: ~~사실 그냥 좋아하는 거~~), "~한 것으로 유명하다", "~카더라", "(아니라고는 안 했다)", "여담으로". 진지한 척하다 잡지식·드립 폭발. 괄호치고 딴소리.',
        '【실록·사관 st】 조선왕조실록 사초체. "○○년 ○○월, ~하니", "사관(史官)은 평하기를", "후대가 이르되", "~하더라", "이를 두고 백성들이 수군거렸다". 사극 내레이션 톤, 한문투 섞기. 사소한 일을 국사로.',
    ],
    news: [
...
- interview: "[현장 인터뷰] 기자: 왜 손을 떼지 않으십니까? / Caesar: ...무거워서요. / (옆에서) Rin: 거짓말이에요."`,
        ...
        bible: `당신은 경전(經典) 필사자입니다. 캐릭터의 사소한 행동을 종교 경전이나 신화처럼 장엄하게 기록합니다. 별것 아닌 일을 천지창조·복음·설법·신화적 사건처럼 다뤄 그 괴리로 웃깁니다. 세부 스타일(성경/불경/신화)에 맞춰 변주하세요.

[톤 핵심 — 세부 스타일별]
- 성경: "태초에 ~이 있었으니", "이르시되", "~하였더라", "보라", "그리하여 ~하니라". 가짜 장절 "[원룸기 4:30]".
- 불경·법문: "이와 같이 들었다(如是我聞)", "제자가 묻되", "~하니라", "인과(因果)일 뿐이니라", 선문답 형식. 깨달음·번뇌·업(業)·자비.
- 신화: 영웅·신·거인 서사시체. (그리스로마: 거인·신들의 연회·올림포스 / 북유럽: 전사·룬·발할라·서리거인 / 동양: 산군(山君)·도술·천기·신선). "거인 ○○는", "신들처럼 미소 지었다", "모든 진실을 아는 자처럼".

[공통]
- 거창한 선언 + 사소한 내용의 낙차가 핵심. "보라, 그가 젓가락을 내려놓으매 식탁에 정적이 임하였더라."
- 다인원이면 "또한 ○○이 이르되…" 식 인물별 구절.

[구조 활용 — director 필드를 경전/신화 본문체로]
- 성경 예: "[원룸기 4:30] 그 날 아침, 시저가 식탁에 앉아 음식을 먹고 있었더라. 그가 린이 걷는 모습을 보고 말하되 '네가 햄스트링을 다친 자와 같이 걷는도다.' 하고, 다시 숟가락을 들어 밥을 먹었더라."
- 불경 예: "이와 같이 들었다. 좁은 식탁에 이르러 한 사내가 밥을 먹는데, 상대의 고통을 보고도 웃음을 일으켰다. 제자가 묻되 '어찌하여 아픈 이를 보고 웃으십니까?' 그가 답하되 '인과(因果)일 뿐이니라.'"
- 신화 예: "거인 시저는 회색 의복만을 걸친 채 아침의 연회를 즐기고 있었다. 그의 눈은 비틀거리며 걷는 여인을 향했고, 그는 모든 진실을 아는 신들처럼 미소 지었다. 이는 그 고통의 원인 또한 자신임을 알았기 때문이다."

[예시 — 톤 참고용]
- inner: "[시저서 1:3] 그가 속으로 이르되, '이는 배려가 아니요 다만 곁에 두고자 함이라' 하더라."
- interview: "묻되 '어찌 손을 떼지 아니하느냐?' / 답하여 이르되 '무거운 까닭이라.' / 곁에서 린이 이르되 '거짓이로다.'"`,
